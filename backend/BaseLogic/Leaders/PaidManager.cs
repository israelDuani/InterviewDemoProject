...
namespace BaseLogic.Leaders
{
    ...
    public class PaidManager : IPaidLeader
    {
        ...
        public PaidManager(string iD, string firstName, string lastName, Address personalAddress, int salary)
        {
            ID = iD;
            FirstName = firstName;
            LastName = lastName;
            ...
            TotalSalary = 0;
            ManagerId = "-1";
            WorkerType = WorkerKind.Kind.PaidManager;
        }
    }
}
